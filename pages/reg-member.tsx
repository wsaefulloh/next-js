...
export default function Register_member() {
    ...
    return (
        <>
            <Head>
            <title>NextJS Basic | Registrasi Member</title>
            ...
            <div className="container">
                <div className="row col-5 m-auto mt-5">
                    ...
                    <input onChange={inputPosition} className="text-center p-2 mt-3" type="text" placeholder="Position" />
